...
class ClientRepository {
  ...
  Future<Client> find(int client_type) async {
    Client client = (await connection.query('SELECT * FROM "client" WHERE client_type = @client_type', {'client_type': client_type})).map(mapRowToClient).first;
    return client;
  }
